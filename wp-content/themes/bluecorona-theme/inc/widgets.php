...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Blog Right Sidebar', 'understrap' ),
				'id'            => 'blogrightside',
		...
		register_sidebar(
			array(
				'name'          => __( 'Sub Page Right Sidebar', 'understrap' ),
				'id'            => 'subpagerightsidebar',
				'description'   => __( 'Include Widgets you need in Sub Page right sidebar', 'understrap' ),
			)
		);

		register_sidebar(
			array(
				'name'          => __( 'Single Blog Right Sidebar', 'understrap' ),
				'id'            => 'singleblogrightside',
		...
		register_sidebar(
			array(
				'name'          => __( 'Geotargeting Widget Area', 'understrap' ),
				'id'            => 'geotargetingsidebar',
		...
		register_sidebar( array(
		    ...
		    'before_widget'  => '<div id="%1$s" class="footer-widget %2$s '. bc_count_widgets( 'footer' ) .'">', 
		    'after_widget'   => '</div><!-- .footer-widget -->', 
		    'before_title'   => '<h3>', 
		    'after_title'    => '</h3>', 
		) );
