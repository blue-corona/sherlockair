    ...
    public function widget( $args, $instance ) {
        ...
        <div class="three-fifths flex-spaced-between-margined-auto-responsive">
            <div class="schema-info text-center two-fifths">
              ...
              <a class="phone-link phone-number-style" href="tel:<?php echo bc_get_theme_mod('bc_theme_options', 'bc_phone',false, '760-295-5014');?>" id="FooterV3_1"><span itemprop="telephone"><span id="FooterV3_2"><?php echo bc_get_theme_mod('bc_theme_options', 'bc_phone',false, '760-295-5014');?></span></span></a>
