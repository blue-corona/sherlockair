...
if( $file ): ?>
	<div class="flex-middle-center over-item relative">
				<video class="full box-shadow" type="video/mp4" src="<?php echo $file['url']; ?>" controls="" poster="/cms/thumbnails/00/800x450/media/vpics/03-Downstown_20171013011841.png" preload="none"></video>
				<meta itemprop="thumbnail" content="/media/vpics/03-Downstown_20171013011841.png"/>
				<meta itemprop="thumbnailUrl" content="http://www.sherlockair.com/media/vpics/03-Downstown_20171013011841.png"/>
